...
printf wpcluster_poc | docker secret create mysql_root_password -     # lb
...
gluster volume create gfs replica 3 web1:/wordpress/1/brick web2:/wordpress/2/brick web3:/wordpress/3/brick   # web1
gluster volume start gfs                                                                                      # web1
#    sec: gluster volume set gfs auth.allow 10.211.55.29,10.211.55.30,10.211.55.31                            # web1
